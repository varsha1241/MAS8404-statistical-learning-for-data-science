...
heptathlon <- rbind(heptathlon, mean_values)
print(heptathlon)
```
...
cov_matrix <- cov(heptathlon[, c("hurdles", "highjump", "shot", "run200m","longjump","run800m","score")])
cov_matrix
```
...
correlation_matrix <- cor(heptathlon[, c("hurdles", "highjump", "shot", "run200m","longjump","run800m","score")])
correlation_matrix
```
